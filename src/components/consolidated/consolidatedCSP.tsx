...
export default function ConsolidatedViewCSP({ data }: Props) {
  ...
  return (
    <div className="p-4">
    <h1  className="text-3xl font-extrabold p-3 my-6 heading">Consolidated View (CSP) </h1>
      ...
      {currentData.map((company, index) => {
        ...
        return (
          <li key={index} className="p-4 border rounded shadow-sm bg-white">
            <Link to={`/CSP/${company.customer_name}`} className="block">
